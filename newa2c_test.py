...
class Actor(tf.keras.Model):
    def __init__(self, num_hidden_units: int):
        ...
        self.actor_pd_sig = tf.keras.layers.Dense(1, kernel_initializer=initializer)
        self.actor_pg_u = tf.keras.layers.Dense(1, activation="relu", kernel_initializer=initializer)
        self.actor_pg_sig = tf.keras.layers.Dense(1, kernel_initializer=initializer)
        self.actor_pb_u = tf.keras.layers.Dense(1, kernel_initializer=initializer)
        self.actor_pb_sig = tf.keras.layers.Dense(1, kernel_initializer=initializer)
